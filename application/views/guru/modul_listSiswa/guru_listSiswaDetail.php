              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Guru/dataMasterSiswa');?>"><small><?= $parent ;?></small></a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('Guru/dataMasterSiswaDetail/'.$this->encrypt->encode($oneSiswa->id_siswa));?>"><small><?= $page ;?></small></a></li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
                ...
                <div class="card-body">
                  ...
                  <form action="#" method="post">
                    ...
                    <div class="form-group text-right">
                      <a class="btn btn-warning btn-sm" href="<?= base_url('Guru/listSiswaEdit/'.$this->encrypt->encode($oneSiswa->id_siswa));?>"><i class="fa fa-edit"></i>&ensp;Edit</a>
                    </div> 
